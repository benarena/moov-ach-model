...
public class Addenda05 {
  ...
  **/
   ...
   * @return typeCode
  **/
  @Schema(example = "05", required = true, description = "05 - NACHA regulations")
  ...
  **/
  @Schema(example = "Car Payment", required = true, description = "Text for describing the related payment")
  ...
  public Addenda05 sequenceNumber(BigDecimal sequenceNumber) {
  ...
  **/
  ...
  public Addenda05 entryDetailSequenceNumber(BigDecimal entryDetailSequenceNumber) {
