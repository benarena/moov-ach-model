...
public class IATBatchHeader {
  ...
  @SerializedName("IATIndicator")
  private String iaTIndicator = null;

  @SerializedName("foreignExchangeIndicator")
  private String foreignExchangeIndicator = null;

  @SerializedName("foreignExchangeReferenceIndicator")
  private Integer foreignExchangeReferenceIndicator = null;

  @SerializedName("foreignExchangeReference")
  private String foreignExchangeReference = null;

  @SerializedName("ISODestinationCountryCode")
  private String isODestinationCountryCode = null;

  @SerializedName("originatorIdentification")
  ...
  @SerializedName("ISOOriginatingCurrencyCode")
  private String isOOriginatingCurrencyCode = null;

  @SerializedName("ISODestinationCurrencyCode")
   ...
   * @return ID
  **/
  @Schema(example = "a747e53f", description = "ID is a client-defined string used as a reference to this record.")
  public String getID() {
    return ID;
  }
  ...
  **/
   ...
   * @return iaTIndicator
  **/
  @Schema(description = "Leave Blank. Only used for corrected IAT entries")
  ...
  **/
  @Schema(example = "FF", required = true, description = "Code indicating currency conversion: 'FV' (Fixed-to-Variable) – Entry is originated in a fixed-value amount and is to be received in a variable amount resulting from the execution of the foreign exchange conversion. | 'VF' (Variable-to-Fixed) – Entry is originated in a variable-value amount based on a specific foreign exchange rate for conversion to a fixed-value amount in which the entry is to be received. | 'FF' (Fixed-to-Fixed) – Entry is originated in a fixed-value amount and is to be received in the same fixed-value amount in the same currency denomination. There is no foreign exchange conversion for entries transmitted using this code. For entries originated in a fixed value amount, the foreign Exchange Reference Field will be space filled. ")
  ...
  **/
  @Schema(example = "2", required = true, description = "Code used to indicate the content of the Foreign Exchange Reference Field and is filled by the gateway operator. Valid entries are 1 - Foreign Exchange Rate | 2 - Foreign Exchange Reference Number | 3 - Space Filled ")
  ...
  **/
  @Schema(required = true, description = "Contains either the foreign exchange rate used to execute the foreign exchange conversion of a cross-border entry or another reference to the foreign exchange transaction.")
  ...
  **/
  @Schema(example = "US", required = true, description = "Two-character code, as approved by the International Organization for Standardization (ISO), to identify the country in which the entry is to be received. For United States use US.")
  ...
  **/
  @Schema(example = "123456789", required = true, description = "For U.S. entities: the number assigned will be your tax ID (often Social Security Number) For non-U.S. entities: the number assigned will be your DDA number, or the last 9 characters of your account number if it exceeds 9 characters ")
  ...
  **/
  @Schema(example = "IAT", required = true, description = "StandardEntryClassCode for consumer and non consumer international payments is IAT. Identifies the payment type (product) found within an ACH batch using a 3-character code. The SEC Code pertains to all items within batch. Determines format of the detail records. Determines addenda records (required or optional PLUS one or up to 9,999 records). Determines rules to follow (return time frames). Some SEC codes require specific data in predetermined fields within the ACH record. ")
  ...
  **/
  @Schema(example = "GAS BILL", description = "A description of the entries contained in the batch The Originator establishes the value of this field to provide a description of the purpose of the entry to be displayed back to the receiver. For example, \"GAS BILL,\" \"REG. SALARY,\" \"INS. PREM,\" \"SOC. SEC.,\" \"DTC,\" \"TRADE PAY,\" \"PURCHASE,\" etc. This field must contain the word \"REVERSAL\" (left justified) when the batch contains reversing entries. This field must contain the word \"RECLAIM\" (left justified) when the batch contains reclamation entries. This field must contain the word \"NONSETTLED\" (left justified) when the batch contains entries which could not settle. ")
  ...
  **/
  @Schema(example = "USD", required = true, description = "Three-character code, as approved by the International Organization for Standardization (ISO), to identify the currency denomination in which the entry was first originated. If the source of funds is within the territorial jurisdiction of the U.S., enter 'USD', otherwise refer to International Organization for Standardization website for value: www.iso.org ")
  ...
  **/
  @Schema(example = "USD", required = true, description = "ISODestinationCurrencyCode is the three-character code, as approved by the International Organization for Standardization (ISO), to identify the currency denomination in which the entry will ultimately be settled. If the final destination of funds is within the territorial jurisdiction of the U.S., enter \"USD\", otherwise refer to International Organization for Standardization website for value: www.iso.org ")
  ...
  public IATBatchHeader effectiveEntryDate(String effectiveEntryDate) {
  ...
  **/
  @Schema(example = "181231", description = "EffectiveEntryDate the date on which the entries are to settle. Format YYMMDD (Y=Year, M=Month, D=Day) ")
  ...
  **/
  @Schema(example = "12345678", required = true, description = "First 8 digits of the originating DFI transit routing number. For Inbound IAT Entries, this field contains the routing number of the U.S. Gateway Operator.  For Outbound IAT Entries, this field contains the standard routing number, as assigned by Accuity, that identifies the U.S. ODFI initiating the Entry. (Format TTTTAAAA - T=Federal Reserve Routing Symbol, A=ABA Institution Identifier) ")
